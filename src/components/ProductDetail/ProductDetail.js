        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="home">
                <div class="head">
                    ...
                    /
                    <a href="../Aisha/shop.html">Sofa Labtops</a>
                    / Albert Armchair, Nubuck White
                </div>
            ...
            <div class="layout">
                ...
                <div class="info">
                    82934<br/><br/>
                    <a href="../Aisha/shop.html">Armhair</a>, <a href="../Aisha/shop.html">Wooden Leg</a>, <a href="../Aisha/shop.html">Satin</a><br/><br/>
                    <a href="../Aisha/shop.html">Tosca</a>, <a href="../Aisha/shop.html">Living Room</a>, <a href="../Aisha/shop.html">Modern</a>
                </div>
            </div>
            <hr/>
            <div class="delivery">
        ...
        <div class="col-12 description">
            ...
            <div class="tab-content">
                <div id="home" class="tab-pane active">
                    ...
                    <p>
                        Curabitur blandit tempus porttitor. Vivamus sagittis lacus vel augue laoreet
                        rutrum faucibus dolor auctor. Integer posuere erat a ante venenatis dapibus
                        posuere velit aliquet. Vestibulum id ligula porta felis euismod semper. Integer
                        posuere erat a ante venenatis dapibus posuere velit aliquet.
                    </p>
                    <p>
                        Maecenas faucibus mollis interdum. Cras justo odio, dapibus ac facilisis in,
                        egestas eget quam. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis
                ...
                <div id="menu2" class="tab-pane fade">
                    <div class="veiw1">
                        ...
                        <p>
                            ...
                            vitae risus tristique posuere. Maecenas faucibus mollis interdum.Praesent commodo
                            cursus magna, vel scelerisque nisl consectetur et. Aenean lacinia bibendum
                        </p>
                    </div>
                    <div class="veiw1">
                        <div class="info">
    ...
    <div class="row">
            ...
            <ProductItem/>
               {/*} <img class="card-img-top" src={image} alt="Card image"/>
                ...
                <div class="card-img-overlay image1">
                    <div class="present">45%</div>
                    <div class="show vImage1" data-toggle="modal" data-target="#myModal">
                        <a class="fas fa-eye"> QUICK VIEW</a>
                    </div>
                </div>

                <div class="card-body">
                    <a class="card-text">labtop</a>, <a href="">Room set</a>
                    <div>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                    ...
                    <h4><a class="card-title">Albert Armchair, Nubuck Broken White</a></h4>
                    <hr/>
                    <p>$120 <span>$120</span></p>
                </div>*/}
    </div>
        </div>
        <div class="col-3 col-lg-3 col-md-6 col-sm-6">
            ...
            <ProductItem/>
               ...
               {/*} <img class="card-img-top" src={image} alt="Card image"/>
                ...
                <div class="card-img-overlay image2">
                    <div class="present">5%</div>
                    <div class="show vImage2" data-toggle="modal" data-target="#myModal">
                        <a class="fas fa-eye"> QUICK VIEW</a>
                    </div>
                </div>
        ...
        <div class="col-3 col-lg-3 col-md-6 col-sm-6">
            ...
            <ProductItem/>
                ...
                <div class="card-img-overlay image4">
                    <div class="present">98%</div>
                    <div class="show vImage4" data-toggle="modal" data-target="#myModal">
                        <a class="fas fa-eye"> QUICK VIEW</a>
                    </div>
                </div>
